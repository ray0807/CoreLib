...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements
    ...
    private void addRefreshableView(Context context, T refreshableView) {
        ...
        addViewInternal(mRefreshableViewWrapper, new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    private LayoutParams getLoadingLayoutLayoutParams() {
        switch (getPullToRefreshScrollDirection()) {
        case HORIZONTAL:
            return new LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.MATCH_PARENT);
        case VERTICAL:
        default:
