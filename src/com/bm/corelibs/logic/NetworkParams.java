...
import com.bm.corelibs.logic.BaseLogic.OnEmulatingData;
...
public class NetworkParams<T> {
	...
	private OnEmulatingData dataListener;
	...
	public NetworkParams<T> setEmulating(OnEmulatingData s) {
		dataListener = s;
		return this;
	}
	
	public OnEmulatingData getEmulating(){
		return dataListener;
	}
